 ...
 */
class PrivateChat(owner: User, target: User, channel: TextChannel) {
     ...
     * The participant
     */
    private val participant: String = target.id
    ...
    fun canEdit(member: Member): Boolean {
        return member.hasPermission(Permission.ADMINISTRATOR) || member.id == owner || member.id == participant
    }
